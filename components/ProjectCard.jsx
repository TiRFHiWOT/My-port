  ...
  return (
    ...
    >
      <div className="h-52 md:h-72 relative group">
        ...
        ></div>
        <div className="z-50 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-full w-[120px] md:w-[180px] h-[60px] md:h-[75px] bg-[#212529] group-hover:shadow-xl opacity-0 group-hover:opacity-70 transition-opacity duration-500 flex justify-center items-center">
          <Link
            href={gitUrl}
            className="w-10 md:w-14 h-10 md:h-14 mr-6 lg:mr-12 rounded-full border-2 relative border-slate-400 hover:border-white hover:text-white flex justify-center items-center group/link"
          >
          ...
          <Link
            href={previewUrl}
            className="w-10 md:w-14 h-10 md:h-14 rounded-full border-2 relative border-slate-400 hover:border-white hover:text-white flex justify-center items-center group/link"
          >
