...
const HomeArt = () => {
  ...
  return (
    ...
    >
      ...
      <ul
        className=" relative w-96 h-96 grid gap-y-0.5 -rotate-12 border-2  border-gray-500 rounded-full z-10 bg-gray-900 justify-center overflow-hidden"
